#!/usr/bin/env python3
"""
Show contents of ROS2 bag directories using rosbags library.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Show contents of ROS2 bag directories")
    parser.add_argument("bag_dir", type=str, help="Path to ROS2 bag directory")
    parser.add_argument("--max-messages", type=int, default=1, help="Maximum messages to show per topic (default: 1)")
    args = parser.parse_args()
    show_bag_contents(args.bag_dir, args.max_messages)
