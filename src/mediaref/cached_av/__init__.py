...
# Bound for the open-and-cache retry loop. Convergence is normally 1–2 iterations;
# the cap defends against pathological ``cleanup_cache()`` contention.
_MAX_OPEN_RETRIES = 8
...
def _open_cached(cache_key: str, file: PathLike, **kwargs) -> "MockedInputContainer":
    ...
    for _ in range(_MAX_OPEN_RETRIES):
